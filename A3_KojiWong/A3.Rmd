...
As the latest version of GSEA was not compatible with Java 11 on the docker image, a previous version compatible was obtained v4.3.3 located in the GSEA directory. Genesets of size betweewn 15 and 200 were taken so as to not get genesets that were too large and dominate over other genesets. Additionally 1000 permutations are used to obtain a significant amount of randomness for the analysis. The most recent gmt file version (March 1, 2025) from the Bader Lab was used which can be obtained [here](https://download.baderlab.org/EM_Genesets/March_01_2025/Human/symbol/#:~:text=Human_GOBP_AllPathways_noPFOCR_no_GO_iea_March_01_2025_symbol.gmt) [@enrichment_map]
